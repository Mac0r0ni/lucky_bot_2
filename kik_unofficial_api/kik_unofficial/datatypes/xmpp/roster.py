...
class FetchRosterResponse(XMPPResponse):
    ...
    def __init__(self, data: BeautifulSoup):
        ...
        # Kik sends <roster full="1"> when the roster is not ready to be served.
        # Wait a few seconds and retry if this is True
        self.is_full = data.query.roster and '1' == data.query.roster['full']
    ...
    def parse_peer(element):
        if element.name == "g":
            ...
            # deleted groups / groups you've left or been removed from
            return Group(element)
        elif element.name != "roster":
...
class GroupSearchResponse(XMPPResponse):
    ...
    class GroupSearchEntry:
        ...
        def __repr__(self):
            return "GroupSearchEntry(jid={}, hashtag={}, name={}, members={})".format(self.jid, self.hashtag,
                                                                                      self.display_name,
                                                                                      self.member_count)
